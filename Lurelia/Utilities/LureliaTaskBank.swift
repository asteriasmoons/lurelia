...
enum LureliaTaskBank {
    ...
    static let allItems: [LureliaTaskBankItem] = [
        ...
        .init(title: "Schedule Important Appointments", category: "Health", coinReward: 30),
        .init(title: "Log Your Health Data", category: "Health", coinReward: 15),
        .init(title: "Check In With Therapist", category: "Health", coinReward: 20),
        .init(title: "Review Upcoming Appointments", category: "Health", coinReward: 15),
        .init(title: "Plan a New Health Routine", category: "Health", coinReward: 25),
        .init(title: "Check Exam Lab Results", category: "Health", coinReward: 20),
        ...
        .init(title: "Clean the Inside of Your Microwave", category: "Home", coinReward: 25),
        .init(title: "Wipe Down the Dishwasher Front", category: "Home", coinReward: 15),
        .init(title: "Wipe Down the Front of Your Refrigerator", category: "Home", coinReward: 15),
        .init(title: "Take Stock of Food Inventory", category: "Home", coinReward: 20),
        .init(title: "Take Stock of Cleaning Supplies", category: "Home", coinReward: 20),
        .init(title: "Refill Cleaning Supplies", category: "Home", coinReward: 20),
        .init(title: "Reorganize Your Dishes on the Shelves", category: "Home", coinReward: 30),
        .init(title: "Sweep Your Floors", category: "Home", coinReward: 25),
        .init(title: "Mop Your Floors", category: "Home", coinReward: 30),
        .init(title: "Vacuum the Couch", category: "Home", coinReward: 25),
        .init(title: "Dust Your Furniture", category: "Home", coinReward: 35),
        .init(title: "Unload the Dishwasher and Reload", category: "Home", coinReward: 25),
        .init(title: "Reorganize Your Sitting Area", category: "Home", coinReward: 30),
        ...
        .init(title: "Use AI to Talk Out Your Feelings", category: "Care", coinReward: 15),
        .init(title: "Take a Hot Shower", category: "Care", coinReward: 25),
        .init(title: "Set Up a Cozy Space to Sit In", category: "Care", coinReward: 15),
        ...
        .init(title: "Spray Some Cleansing Spray", category: "Spirituality", coinReward: 10),
        .init(title: "Clear Your Aura", category: "Spirituality", coinReward: 15),
        .init(title: "Work With Your Chakras", category: "Spirituality", coinReward: 20),
        .init(title: "Put Out New Offerings", category: "Spirituality", coinReward: 15),
        .init(title: "Pull a Lenormand Card or Spread", category: "Spirituality", coinReward: 15),
        .init(title: "Clean Your Altar", category: "Spirituality", coinReward: 25),
        .init(title: "Write in Your Grimoire", category: "Spirituality", coinReward: 25),
        .init(title: "Add to Your Book of Shadows", category: "Spirituality", coinReward: 25),
        .init(title: "Craft a New Tool", category: "Spirituality", coinReward: 30),
        .init(title: "Read Your Daily Horoscope", category: "Spirituality", coinReward: 10),
        .init(title: "Do One of Your Moon Rituals", category: "Spirituality", coinReward: 25),
        .init(title: "Check the Current Lunar Phase", category: "Spirituality", coinReward: 10),
        .init(title: "Make a Vision Board", category: "Spirituality", coinReward: 30),
        .init(title: "Cleanse Your Crystals", category: "Spirituality", coinReward: 15),
        .init(title: "Say a Short Blessing to Deity", category: "Spirituality", coinReward: 10),
        ...
        .init(title: "Restock Planner Supplies", category: "Intention", coinReward: 20),
        .init(title: "Treat Yourself to Some Stickers", category: "Intention", coinReward: 10),
        .init(title: "Gift Yourself a New Planner", category: "Intention", coinReward: 25),
        .init(title: "Write a Morning Reflection", category: "Intention", coinReward: 15),
        .init(title: "Decide On One Thing to Do Intentionally", category: "Intention", coinReward: 15),
        .init(title: "Review Your Intentions and Their Goals", category: "Intention", coinReward: 20),
        ...
        .init(title: "Refresh Your Calendar", category: "Productivity", coinReward: 15),
        .init(title: "Clear Any Pending Notes", category: "Productivity", coinReward: 20),
        .init(title: "Check Your Reminders App", category: "Productivity", coinReward: 10),
        .init(title: "Run a Routine and Do Your Tasks", category: "Productivity", coinReward: 25),
        .init(title: "Do a Digital Detox With Limily", category: "Productivity", coinReward: 30),
        ...
        .init(title: "Restock On Razors or Razor Heads", category: "Hygiene", coinReward: 20),
        .init(title: "Count and List Items You Need to Rebuy", category: "Hygiene", coinReward: 15),
        .init(title: "Organize Your Clothes in the Closet", category: "Hygiene", coinReward: 30),
        .init(title: "Donate Old Clothes You No Longer Want or Need", category: "Hygiene", coinReward: 30),
        .init(title: "Order a New Nail Kit", category: "Hygiene", coinReward: 15),
        .init(title: "Soak Your Feet in a Designated Bucket/Bin", category: "Hygiene", coinReward: 20),
        .init(title: "Put Lotion On Your Feet", category: "Hygiene", coinReward: 10),
        .init(title: "Use Electric Foot File", category: "Hygiene", coinReward: 15),
        .init(title: "Replace the Shower Liner", category: "Hygiene", coinReward: 25),
